...
$select_query = "SELECT * from user_video natural join users WHERE id=$u_id";
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<?php if (isset($_SESSION['usr_id'])) { ?>
					<li><a href="urvideo.php" class="news-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Your Videos</a></li>
					<?php } ?>
				  </ul>
				  <!-- script-for-menu -->
						<script>
				...
				<div class="top-grids">
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						...
						<div class="resent-grid-info recommended-grid-info">
							<h3><a href="<?php echo $row['v_dir']; ?>" class="title title-info"><?php echo $row['v_name']; ?></a></h3>
							<ul>
								<li><p class="author author-info"><a href="#" class="author"></a><?php echo $row['name']; ?></p></li>
								<li class="right-list"><p class="views views-info">2,114,200 views</p></li>
							</ul>
							<a href="delete.php?id=<?php echo $row['v_id']; ?>" class="btn btn-danger">Delete</a></td>
						</div>
					</div>
					<?php } ?>
					<div class="clearfix"> </div>
